...
CREATE TABLE towns (
    ...
    CONSTRAINT fk_towns_country_id__countries_id
...
CREATE TABLE stadiums (
    ...
    CONSTRAINT fk_stadiums_town_id__towns_id
...
CREATE TABLE teams (
    ...
    CONSTRAINT fk_teams_stadium_id__stadiums_id
...
CREATE TABLE players (
    ...
    team_id INT(11),
    CONSTRAINT fk_players_skills_data_id__skills_data_id
    FOREIGN KEY (skills_data_id) REFERENCES skills_data(id),
    CONSTRAINT fk_players_team_id__teams_id
...
CREATE TABLE players_coaches (
	player_id INT(11) ,
    coach_id INT(11),
    CONSTRAINT fk_players_coaches_player_id__players_id
    FOREIGN KEY (player_id) REFERENCES players(id),
    CONSTRAINT fk_players_coaches_coach_id__coaches_id
